                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @forelse($buyingSelling as $item)
                                        <tr>
                                            <td>{{ $loop->iteration + ($buyingSelling->currentPage() - 1) * $buyingSelling->perPage() }}
                                            </td>
                                            ...
                                            <td>{{ $item->box_type }}</td>
                                            {{-- <td>{{ $item->cold_store_details }}</td>
                                            <td>{{ $item->total }}</td>
                                            <td>{{ $item->kg_box_total }}</td>
                                            <td>{{ $item->selling_date }}</td>
                                            <td>{{ $item->selling_price }}</td>
                                            <td>{{ $item->selling_kg_box }}</td>
