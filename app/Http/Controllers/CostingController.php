...
class CostingController extends Controller
{
    ...
    public function storeLc(Request $request)
    {
        ...
        // Update the costing record with LC ID
    ...
    public function updateCosting(Request $request)
    {
        ...
        // Recalculate totals
        $baseValue = $costing->base_value;
        $qty = $costing->qty;
        $exchange = $costing->exchange_rate;
        $transport = $costing->transport;
        $arrot = $costing->arrot;
        ...
        $insurance_tk = $insurance * $exchange;
        $landing_charge = ($total + $insurance) * 0.01;
        $landing_charge_tk = $landing_charge * $exchange;
        ...
        $others_total = $transport + $arrot + $cns;
        ...
        $total_cost_per_kg = $tariff_per_kg_lc - ($actualValue / $boxTypeValue * $exchange);
        $total_cost_per_box = $total_cost_per_kg * 20;
        ...
        $costing->transport            = $transport;
        $costing->arrot                = $arrot;
        $costing->cns_charge           = $cns;
        ...
        return redirect()->back()->with('success', 'Costing updated successfully!');
    }
}
