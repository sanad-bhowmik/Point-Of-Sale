...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('*-costing.index') ? 'c-show' : '' }}" id="costing">
    ...
    <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link {{ request()->routeIs('costing.lcCostingReport') ? 'c-active' : '' }}"
                href="{{ route('costing.lcCostingReport') }}">
...
<li class="c-sidebar-nav-item c-sidebar-nav-dropdown
    {{ request()->routeIs('office_expense.*') || request()->routeIs('expense-categories.*') ? 'c-show' : '' }}"
    id="expenses">

    <a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
        <i class="c-sidebar-nav-icon bi bi-box" style="line-height: 1;"></i>
        Office Expense
    </a>
