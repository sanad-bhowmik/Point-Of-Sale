...
<div class="col-lg-12">
    @if(isset($find_containers) && count($find_containers) > 0)
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-gradient-info text-white">
                <h6 class="mb-0 fw-bold" style="display: flex;">
                    ...
                    <span class="mt-2 ml-2">Details of cash flow</span>
                </h6>
            </div>
                ...
                <div class="table-responsive">
                    <table id="cashflow-table" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach($find_containers as $index => $container)
                                @php
                                    // Fetch LC details (assuming 'lc' relationship is defined in Container model)
                                    $lc = $container->lc;
                                    ...
                                    // LC cost and TT cost
                                    $lcCost = ($container->lc_value ?? 0) * ($container->lc_exchange_rate ?? 0) * ($container->qty ?? 0);
                                    $ttCost = ($container->tt_value ?? 0) * ($container->tt_exchange_rate ?? 0) * ($container->qty ?? 0);
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: {{ $profit_loss > 0 ? '#9eff86' : '#ff8e7a' }};">
                            ...
                            <tr style="background: #f1f1f1;">
                                ...
                                <td>{{ $totalProfit - $totalLoss > 0 ? 'Till now profit' : 'Till now loss' }}</td>
                            </tr>
